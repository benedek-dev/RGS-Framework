...
RGS is exclusively an **Unreal Engine 5** studio. All engine-specific work is handled by the five UE5 specialist agents below.

### UE5 Lead

| Agent | Engine | Model | When to Use |
| ---- | ---- | ---- | ---- |
| `unreal-specialist` | Unreal Engine 5 | Sonnet | Blueprint vs C++, GAS overview, UE subsystems, project-wide optimization |
...
| `ue-blueprint-specialist` | Blueprint Architecture | Sonnet | BP/C++ boundary, graph standards, naming conventions, BP optimization |
